...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2026 a las 02:52:01
...
INSERT INTO `datos` (`id`, `nombres`, `estado`, `dni`, `telefono`, `idRol`, `fecha`) VALUES
(1, 'Carlos Cavalier', '1', 23456789, 987654321, 1, '2025-05-12'),
(2, 'Laura Flores', '1', 34567890, 123456789, 2, '2025-05-12'),
(4, 'John Llave', '1', 27440013, 999458372, 7, '2025-05-13'),
(5, 'MILAGROS JULIA TERESA', '1', 27440013, 999458377, 1, '2025-05-14'),
(6, 'RICARDO GERMAN', '1', 29607137, 978787878, 1, '2025-05-14'),
(7, 'ALEJANDRA', '1', 29607137, 999458378, 1, '2026-03-16');
...
(5, 'Interfaz de Pedidos', '/Principal/Page/Pedidos', 'pi pi-send'),
