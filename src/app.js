...
dotenv.config();
const corsOptions = {
    origin: ['http://localhost:3000','http://localhost:4000','https://eventos.asociaciondebodegueros.com','https://dashboard.eventos.asociaciondebodegueros.com'], // Orígenes permitidos
